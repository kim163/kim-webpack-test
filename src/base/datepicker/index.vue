<template>
  <div class="date-picker">
    <div class="date-picker-wrapper" @click="togglePanel" @mouseenter="showCancel = true" @mouseleave="showCancel = false">
      ...
      <slot v-show="!showCancel">&nbsp;
        <i class="iconfont datepicker-icon-time icon-time"></i>
      </slot>
    </div>
...
<script>
  export default {
    data() {
      let now =this.value==''?new Date():new Date(this.value)
      return {
        showCancel: false,
        panelState: false,
        panelType: 'date',
